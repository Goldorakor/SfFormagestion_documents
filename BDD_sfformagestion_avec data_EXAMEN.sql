...
-- Listage des données de la table sfformagestion.encadrement : ~10 rows (environ)
...
-- Listage des données de la table sfformagestion.inscription : ~28 rows (environ)
...
-- Listage des données de la table sfformagestion.planification : ~28 rows (environ)
INSERT INTO `planification` (`id`, `session_id`, `module_id`, `duree`, `date_debut`, `date_fin`) VALUES
	...
	(6, 2, 1, 120, '2025-02-24 09:00:00', '2025-02-24 11:00:00'),
	(7, 2, 2, 60, '2025-02-24 11:00:00', '2025-02-24 12:00:00'),
	(8, 2, 3, 60, '2025-02-24 13:00:00', '2025-02-24 14:00:00'),
	(9, 2, 4, 120, '2025-02-24 14:00:00', '2025-02-24 16:00:00'),
	(10, 2, 5, 60, '2025-02-24 16:00:00', '2025-02-24 17:00:00'),
	(11, 3, 12, 60, '2025-03-05 09:00:00', '2025-03-05 10:00:00'),
	(12, 3, 13, 60, '2025-03-05 10:00:00', '2025-03-05 11:00:00'),
	(13, 3, 14, 60, '2025-03-05 11:00:00', '2025-03-05 12:00:00'),
	(14, 3, 15, 60, '2025-03-05 13:00:00', '2025-03-05 14:00:00'),
	(15, 3, 16, 60, '2025-03-05 14:00:00', '2025-03-05 15:00:00'),
	(16, 3, 17, 120, '2025-03-05 15:00:00', '2025-03-05 17:00:00'),
	(17, 4, 12, 60, '2025-03-15 09:00:00', '2025-03-15 10:00:00'),
	(18, 4, 13, 60, '2025-03-15 10:00:00', '2025-03-15 11:00:00'),
	(19, 4, 14, 60, '2025-03-15 11:00:00', '2025-03-15 12:00:00'),
	(20, 4, 15, 60, '2025-03-15 13:00:00', '2025-03-15 14:00:00'),
	(21, 4, 16, 60, '2025-03-15 14:00:00', '2025-03-15 15:00:00'),
	(22, 4, 17, 120, '2025-03-15 15:00:00', '2025-03-15 17:00:00'),
	(23, 5, 6, 90, '2025-05-17 08:00:00', '2025-05-17 09:30:00'),
	(24, 5, 7, 90, '2025-05-17 09:30:00', '2025-05-17 11:00:00'),
	(25, 5, 8, 60, '2025-05-17 11:00:00', '2025-05-17 12:00:00'),
	(26, 5, 9, 90, '2025-05-17 13:00:00', '2025-05-17 14:30:00'),
	(27, 5, 10, 90, '2025-05-17 14:30:00', '2025-05-17 16:00:00'),
	(28, 5, 11, 120, '2025-05-17 16:00:00', '2025-05-17 18:00:00');
...
INSERT INTO `representant` (`id`, `nom`, `prenom`, `sexe`, `fonction`, `tampon`) VALUES
	(1, 'VAROL', 'Nalan', 'F', 'dirigeante', 'public/uploads/images/Signature.jpg');
...
-- Listage des données de la table sfformagestion.session : ~5 rows (environ)
INSERT INTO `session` (`id`, `formation_id`, `titre_session`, `accroche`, `nb_places`, `date_debut`, `date_fin`) VALUES
	...
	(5, 8, '[ENF][01][PRE][INTRA]', NULL, 8, '2025-05-17 09:00:00', '2025-05-17 17:00:00');
...
-- Listage des données de la table sfformagestion.sondage : ~15 rows (environ)
